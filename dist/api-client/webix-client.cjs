const require_host = require('../webix/host.cjs');
...
var WebixApiClient = class {
	constructor(opts = {}) {
		...
		this.createdAt = now();
		this.host = new require_host.WebixHost(opts);
	...
	async mkDir(params) {
		await this.ensureBooted();
		const full = require_normalizePath.normalizePath({
...
exports.WebixApiClient = WebixApiClient;
//# sourceMappingURL=webix-client.cjs.map