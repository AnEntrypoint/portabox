...
var Snapshot = class {
	...
	*/
	static async list() {
		throw new require_webix_client.NotSupportedError("Snapshot.list is unavailable in the self-contained sandbox: snapshots are held by a live in-browser host, not a remote account. Use sandbox.snapshot() and keep the returned Snapshot.");
	}
	/**
	...
	*/
	static async tree() {
		throw new require_webix_client.NotSupportedError("Snapshot.tree is unavailable in the self-contained sandbox.");
	}
	/**
	...
	*/
	static async get() {
		throw new require_webix_client.NotSupportedError("Snapshot.get is unavailable in the self-contained sandbox: keep the Snapshot returned by sandbox.snapshot().");
	}
	/**
