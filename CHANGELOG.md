...
- Initial release of `portabox`: a self-contained, in-browser x86_64 Linux sandbox SDK backed by the webix/Blink WASM emulator. Derived from `@vercel/sandbox` (Apache-2.0) with the remote backend removed.
